    ...
    <div className="bg-background text-foreground min-h-screen">
      ...
      <section id="contact" className="relative py-28 lg:py-40 px-6 lg:px-10 border-t border-border overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <Reveal delay={400}>
            <a
              href="https://mail.google.com/mail/?view=cm&fs=1&to=nicoelljnkr@gmail.com&su=Inquiry%20from%20your%20portfolio&body=Hi%20Nicolle%2C%0A%0AI%27d%20like%20to%20connect%20about..."
              target="_blank"
              rel="noopener noreferrer"
              onClick={(e) => {
                // Fallback to mailto if Gmail can't open (e.g. user prefers default client)
                // Primary action stays Gmail compose in a new tab.
                void e;
              }}
